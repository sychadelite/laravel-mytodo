...
<div class="mt-8">
  <h2 class="text-left text-base font-bold text-gray-800 mb-4">Completed Tasks</h2>
        ...
        <div class="flex flex-wrap items-center justify-between gap-4">
          <div>
            <div class="flex flex-wrap gap-1">
              <h3 class="text-lg font-semibold text-gray-700 line-through">{{ $task->title }}</h3>
            ...
            <p class="text-gray-600 mt-2 line-through">{{ $task->description }}</p>
            @php
          ...
          <div class="flex flex-wrap justify-center items-center gap-3">
            ...
            <form action="{{ route('tasks.update', $task->id) }}" method="POST">
              ...
              <button type="submit" class="bg-transparent text-black ring-2 ring-black font-bold p-1 rounded-full focus:outline-none focus:shadow-outline cursor-no-drop" disabled>
